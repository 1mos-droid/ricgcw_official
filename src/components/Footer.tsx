  ...
  return (
    <footer className="py-16 px-6 border-t border-ios-separator/10 bg-white/50 backdrop-blur-md">
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        <h3 className="text-xl font-black mb-2 text-ios-label">Inner Court Gospel Church (Worldwide)</h3>
        <p className="ios-caption mb-8">© 2026 ICGCW. All rights reserved.</p>
